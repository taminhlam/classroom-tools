...
function Student(sex) {
    ...
    this.dad = Math.floor((Math.random() * 11) + 3)+32;
    this.mom = Math.floor((Math.random() * 11) + 1)+30;
    ...
    this.bro = Math.round((Math.random() * 3));
    this.sis = Math.round((Math.random() * 3));
    ...
    this.photo = "media/" + this.sex + "/" + Math.round((Math.random() * 12)) + ".png";
};
...
function createMedicalRecord() {
    ...
    $('#sis').html(repeat("<i class='fa fa-female' style='color: red;'></i>", patient.sis) + repeat("<i class='fa fa-male' style='color: blue;'></i>", patient.bro));
    $('#bro').html(repeat("<i class='fa fa-male' style='color: blue;'></i>", patient.bro));
    $('#ageF').text(patient.dad);
    $('#ageM').text(patient.mom);
        $('#jobF').text(patient.jobF);
    $('#jobM').text(patient.jobM);
    $('#photo').html("<img src='" + patient.photo + "' class='right'>");
};
